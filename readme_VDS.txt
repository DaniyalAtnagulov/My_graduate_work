...
User=daniyal
Group=www-data
WorkingDirectory=/home/daniyal/myappleshoptest.sytes.net
ExecStart=/home/daniyal/myappleshoptest.sytes.net/venv/bin/gunicorn \
          --access-logfile - \
          --workers 3 \
...
server {
    ...
    location /static/ {
        root /home/daniyal/myappleshoptest.sytes.net/static/static_prod;
    }

    location /media/ {
        root /home/daniyal/myappleshoptest.sytes.net/static/media;
    }
}
...
#   location /media/ {
#        root /home/daniyal/myappleshoptest.sytes.net/;
#    }
...
Н: ssh -L 5001:localhost:5432 daniyal@85.193.91.73
